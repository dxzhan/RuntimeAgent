 ...
 * @author sam
 */
public class RTAServiceRegistry implements Closeable
{
    private static final Logger logger = LoggerFactory.getLogger(RTAServiceRegistry.class);
    private final ServiceDiscovery<ServiceInstanceDetail> serviceDiscovery;
    private final CuratorFramework client;
    private final String basePath;
    private boolean running = false;

    public RTAServiceRegistry(CuratorFramework client, String basePath) throws Exception
    {
        this.client = client;
    ...
    public void registerService(ServiceInstance<ServiceInstanceDetail> serviceInstance) throws Exception {
        if (isRunning()) {
            ...
            logger.warn("RTAServiceRegistry is not running");
        }
    }
