 ...
 * @author sam
 */
public class LightSentinelConstant {
     ...
     * LightSentinel根路径
     */
    public static final String LIGHT_SENTINEL_ROOT_PATH_NAME = "/rta";
    /**
     * LightSentinel事件路径，其下挂载down和up
     */
    public static final String LIGHT_SENTINEL_EVENT_PATH_NAME = "/event";
    /**
     * 服务路径，用于service的管理
     */
    public static final String LIGHT_SENTINEL_SERVICE_PATH_NAME = "/service";
    ...
    /**
     * LightSentinel公共上行事件路径
     */
    public static final String LIGHT_SENTINEL_UPEVENT_PATH_NAME = "/up";
    /**
     * LightSentinel公共下行事件路径
     */
    public static final String LIGHT_SENTINEL_DOWNEVENT_PATH_NAME = "/down";
